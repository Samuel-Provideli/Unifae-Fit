				...
				<ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item pcoded-hasmenu">
					    ...
					    <ul class="pcoded-submenu">
					        ...
					        <li><a href="layout-vertical.html" target="_blank">Usuario</a></li>
					        <li><a href="layout-horizontal.html" target="_blank">Administrador</a></li>
...
<!------------------------ Abrimento para o footer que fechara em outro arquivo php ----------------------->
