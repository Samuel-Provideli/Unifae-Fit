...
foreach($matricula as $matriculas){
        $resultado .= '<tr>
            ...
            //Para a proxima semana resolver as datas da matricula e apagar todas pois as datas sao relacionadas ao plano, deve se fazer uma conta da data onse se pega a data de hoje multiplica pela duraçao e entrega a data final! organizar e mostrar, a matricula tera apenas 2 coisas selecionar o nome e o plano no formulario, apenas
