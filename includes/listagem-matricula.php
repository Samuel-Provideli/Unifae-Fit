...
<a href="realizar-matricula.php" style="display: inline-block; text-decoration: none; margin: 2% 3%;">
                  <button type="button" class="btn btn-primary"><h4>Cadastrar Matricula</h4></button>
                </a>
